...
<body>
    <nav>
        <div class="navbar-left">
            <a href="svhomepage.php">FYP PORTAL</a>
        </div>
    ...
    <button type="submit" id="searchButton" class="search-button">
        ...
        <li><a href="svhomepage.php">Home</a></li>
            <li><a href=sv_approval.php>Proposal Approval</a></li>
            <li><a href="progresstracking.php">Progress Tracking</a></li>
            <li><a href=mmanage.php>Meeting Management</a></li>
            <li><a href=marksheet.php>Marksheet</a></li>
            <li><a href=sv_assign.php>Student Assignment</a></li>
            <li><a href=svprofile.php>Profile</a></li>
            <li><a href="svlogin.php">
