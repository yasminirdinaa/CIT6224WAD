...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE users SET password = ? WHERE id_number = ? AND role = 'supervisor'");
    $stmt->bind_param("ss", $hashed_password, $id_number);
    if ($stmt->execute()) {
        echo "Password updated successfully. <a href='svlogin.php'>Login now</a>";
    } else {
...
<body>
    <div class="background">
        ...
        <a href="svlogin.php" class="back-btn">Back to Login</a>
    </div>
</body>
