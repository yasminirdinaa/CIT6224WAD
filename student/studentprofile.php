...
<div class="container">
    ...
    <div class="profile">
        ...
        <table>
        <tr>
        <th rowspan="7" ><img src="<?php echo htmlspecialchars(!empty($profile_picture) ? $profile_picture : 'uploads/defaultpic.png'); ?>" alt="Profile Picture" width="150" height="150">
        </th>
        </tr>
        <tr>
            <th>Full Name</th>
        ...
        <form id="edit-form" method="POST" action="studentprofile.php" enctype="multipart/form-data" style="display: none;">
            <h2>Edit Profile</h2>
            ...
            <select id="program" name="program" required>
                ...
                <option value="Cybersecurity" <?php echo ($program == "Cybersecurity") ? 'selected' : ''; ?>>Cybersecurity</option>
                <option value="Data Development" <?php echo ($program == "Data Development") ? 'selected' : ''; ?>>Data Development</option>
                <option value="Data Science" <?php echo ($program == "Data Science") ? 'selected' : ''; ?>>Data Science</option>
            </select>
            ...
            <select id="supervisor" name="supervisor" required>
                ...
                <?php foreach ($supervisors as $sup): ?>
                    <option value="<?php echo htmlspecialchars($sup); ?>" <?php echo ($supervisor == $sup) ? 'selected' : ''; ?>><?php echo htmlspecialchars($sup); ?></option>
                <?php endforeach; ?>
            </select>
